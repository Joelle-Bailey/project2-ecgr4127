...
void setup() {
  ...
  //tflite::AllOpsResolver::AllOpsResolver() micro_op_resolver;
  //NOLINTNEXTLINE(runtime-global-variables)
...
void loop() {
  ...
  RespondToCommand(error_reporter, current_time, found_command, score, is_new_command);
    ...
    if (1) {
      ...
      else if (found_command == "wow") {
        ST7735_FillRectangle(0, 90, ST7735_WIDTH, 70, ST7735_GREEN);
        ST7735_WriteString(30, 90, found_command, Font_11x18, ST7735_BLACK, ST7735_GREEN);
      }
      else {
        ST7735_FillRectangle(0, 90, ST7735_WIDTH, 70, ST7735_BLUE);
        ST7735_WriteString(1, 90, found_command, Font_11x18, ST7735_BLACK, ST7735_MAGENTA);
      }
    }
  #endif
}
